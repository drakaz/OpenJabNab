...
<fieldset>
	...
	<span class="fieldName">Add a city <input type="radio" name="a" value="addcity" /></span>Name: <input type="text" name="addC"><br />

	<hr />
	<span class="fieldName">Add a webcast <input type="radio" name="a" value="webcast" /></span>at: <input type="text" name="webcastT" maxlength="5" style="width:50px" /> <i>(hh:mm)</i> &nbsp;&nbsp;&nbsp;&nbsp; for city: 
