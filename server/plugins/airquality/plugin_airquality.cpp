...
PluginAirquality::PluginAirquality():PluginInterface("airquality", "Air quality plugin", BunnyZtampPlugin, QStringList () << "OnSingleClick")
{
...
bool PluginAirquality::OnSingleClick(Bunny * b)
{
